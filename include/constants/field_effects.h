...
#define FLDEFF_OLD_FIELD_MOVE_SHOW_MON_INIT 60
#define FLDEFF_USE_TOMB_PUZZLE_EFFECT    61
#define FLDEFF_PCTURN_ON                 62
#define FLDEFF_HALL_OF_FAME_RECORD       63
#define FLDEFF_USE_TELEPORT              64
#define FLDEFF_RAYQUAZA_SPOTLIGHT        65
#define FLDEFF_DESTROY_DEOXYS_ROCK       66
...
#define FLDEFF_MON_ANIM_CUT             SPECIES_SKORUPI
#define FLDEFF_MON_ANIM_ROCK_SMASH      SPECIES_DWEBBLE
#define FLDEFF_MON_ANIM_STRENGTH        SPECIES_CRUSTLE
#define FLDEFF_MON_ANIM_WATERFALL       SPECIES_GOLISOPOD
#define FLDEFF_MON_ANIM_DIVE            SPECIES_ARMALDO
#define FLDEFF_MON_ANIM_SURF            SPECIES_ARAQUANID
