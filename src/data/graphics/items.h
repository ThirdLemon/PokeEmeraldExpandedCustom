...
const u32 gItemIcon_Pokerider[] = INCBIN_U32("graphics/items/icons/pokerider.4bpp.lz");
const u32 gItemIconPalette_Pokerider[] = INCBIN_U32("graphics/items/icon_palettes/pokerider.gbapal.lz");